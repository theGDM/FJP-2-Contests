// There is a garden and Aman is the gardener and he wants to arrange trees in a
// row
// of length n such that every Kth plant is non-decreasing in height. For
// example the plant
// at position 1 should be smaller than or equal to the tree planted at position
// 1+K and plant
...
// Now Aman can change a plant at any position with a plant of any height in
// order to create
// the required arrangment. He wants to know minimum number of trees he will
// have to change to get the required arrangement.

// We"ll be given a plants array which represents the height of plants at every
// position
// and a number K and we need to output the minimum number of plants we will
// have to change to get the required arrangement.
