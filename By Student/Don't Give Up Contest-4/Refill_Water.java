...
public class Refill_Water {
    ...
    public static void main(String[] args) {
        ...
        int step = 0;
        int i = 0;
        int availbleWater = capacity;
        while(i < n){
            if(availbleWater >= plants[i]){
                availbleWater = availbleWater - plants[i];
                ++step;
                ++i;
            }else{
                availbleWater = capacity; //refill water
                step = step + 2 * i;
                //need to multiply by 2, as i step for going back and refill, and i step for coming back at 
                //same plant
            }
        }
